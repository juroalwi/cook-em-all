...
export default function reducer(state = initialState, { type, payload }) {
  switch (type) {
    ...
    case FILTER_RECIPES:
      const [newFilters, filteredRecipes] = filterRecipes(
        [...state.recipes.fetched],
        [...state.recipesDisplayParameters.filters],
        payload,
      );
      return {
        ...state,
    ...
    case SORT_RECIPES:
      const removeSortCriteria =
        payload === state.recipesDisplayParameters.sortCriteria;
      return {
        ...state,
        recipes: {
          ...state.recipes,
          displayed: removeSortCriteria
            ? state.recipes.fetched
            : sortRecipes([...state.recipes.displayed], payload),
        },
        recipesDisplayParameters: {
          ...state.recipesDisplayParameters,
          page: 0,
